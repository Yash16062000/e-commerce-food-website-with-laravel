				...
				<div class="tables">
					...
					<div class="panel-body widget-shadow">
						...
						<?php if(Auth::user()->user_type!=1): ?>
							...
							if(!empty($check)) {
							?>
							<a class="btn btn-primary" href="<?php echo e(route('admin.add-dish')); ?>"><i class="fa fa-plus" aria-hidden="true"></i>&nbsp;Add New Dish</a><br>
							<?php
							}
							?>
...
<script src="https://cdn.datatables.net/1.10.21/js/dataTables.bootstrap4.min.js"></script>
  ...
  $(function () {
    ...
    var table = $('.dish-datatable').DataTable({
		...
		dom: "Bfrtip",
        serverSide: true,		
        ajax: "<?php echo e(route('admin.getproduct-list')); ?>",
        columns: [
...
<?php echo $__env->make('backend.dashboard.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\e-commerce\resources\views/backend/dashboard/dish-list.blade.php ENDPATH**/ ?>