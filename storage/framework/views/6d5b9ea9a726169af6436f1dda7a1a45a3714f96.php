...
<script type="text/javascript">
  $(function () {
    ...
    var table = $('.user-datatable').DataTable({
        processing: true,
        serverSide: true,		
        ajax: "<?php echo e(route('admin.getuser-list')); ?>",
        columns: [
...
function RemoveUser(user_id){
    ...
    headers: {
        ...
        type:'GET',
        url: "<?php echo e(route('admin.remove_user')); ?>",			  
        data:data,              
        success: (response) => {
    ...
    function EditUserInfo(user_id){   
      ...
      headers: {
        ...
        type:'GET',
        url: "<?php echo e(route('admin.edit-user-details')); ?>",			  
        data:data,              
...
<?php echo $__env->make('backend.dashboard.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\e-commerce\resources\views/backend/dashboard/user-list.blade.php ENDPATH**/ ?>