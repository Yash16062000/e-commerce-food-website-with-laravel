...
<!-- css files -->
<link rel="stylesheet" href="{{url('Backend/css/style-login.css')}}" type="text/css" media="all" /> <!-- Style-CSS --> 
<link rel="stylesheet" href="{{url('Backend/css/font-awesome-login.css')}}"> <!-- Font-Awesome-Icons-CSS -->
<!-- //css files -->

<!-- js -->
<script type="text/javascript" src="{{url('Backend/js/jquery-2.1.4.min.js')}}"></script>
<!-- //js -->
...
<body>
<script src="{{url('Backend/js/jquery.vide.min.js')}}"></script>
	<!-- main -->
